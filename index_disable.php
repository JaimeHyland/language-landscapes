...
// Set email variables
$email_to = 'info@uage-landscapes.com';
...
<div id="formWrap">
    ...
    <?php if($form_complete === FALSE): ?>
    	...
    	<div class="row">
            ...
            <div class="input">
            	<textarea id="bodytext" name="bodytext" class="mess"><?php echo isset($_POST['bodytext'])? $_POST['bodytext'] : 'd'; ?></textarea><?php if(in_array('bodytext', $validation)): ?><span class="error"><?php echo $error_messages['bodytext']; ?></span><?php endif; ?>
            </div><!-- end of input -->
    	</div><!-- end of row -->
        <div class="submit">
