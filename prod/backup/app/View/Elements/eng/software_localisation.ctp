...
<div class="panel-group" id="accordion1">
      ...
      <div class="panel-body">
  		...
  		<div class="panel panel-default">
    		...
    		<div id="collapseOneTwo" class="panel-collapse collapse">
      			<div class="panel-body">
        		 <p>Whether the system you are localizing is a simple website, a desktop program or a sophisticated web application, there will inevitably be a list of different decisions you'll need to make on how you approach the localisation challenge. Most of these decisions will depend on the needs of prospective users, but they're also likely to be influenced by the capabilities of the platforms you are using and your budget. Amongst the things you'll need to consider are the extent to which you need to adjust front-end code to show currency values and dates, etc. correctly in each locale, what mechanism the software uses to decide what language to display, etc.  You'll also need to decide how to fit your localisation workflow into your development lifecycle. Language Landscapes can guide you through all these options in a simple and systematic predefined process.</p>
		
					   <p>Every website or software package is likely to change over time – whether it's a fast-moving news site, a relatively static set of pages presenting a product, a sophisticated cloud application or a simple desktop utility. That's why one of the most important issues you are going to need to decide on is how you want your localisation framework to respond to the change. A number of philosophical approaches are possible:
						  <ol>
					   ...
					   <p>In practice, most software packages will broadly follow Approach 1 and complete localisation into all their chosen locales before each release of a new version of the program, while most owners of relatively sophisticated modern websites will consciously or unconsciously choose a combination of all three approaches, with different elements in the website being treated differently, depending on how dynamically they change and how relevant they are to the website owner's various markets. You will need to consider your localisation resources, the architecture of your site and your communication needs in order to decide which approach to adopt in the various sections of your site. Language Landscapes can guide you through these decisions in conjumction with your web developer.  It is important, however, for you to decide what approach you are taking where, and to know why you have made that choice. Language Landscapes can discuss these issues with you, and advise you on the best approach in each content category.</p>

					   <p>You'll also need to decide what languages are shown when a user first opens the site or program, and how that changes depending on user actions. How, for example, does the site decide what language to use when it opens?  Or what precisely happens when you press the button to switch to a new language?  Are you sent back to the home page in the new language or does the current screen simply switch language? For software packages the choices are slightly different: does each package sóld contain resources for a single language only, or does it allow the user to switch?; can the user change languages dynamically, or do they need to restart every time? With web localisation what you decide depend as much on your content and your localisation approach as it will on the platforms you are using, while software localisation dynamics often tend to be more platform driven.
      		  </div>
    		</div>
    	</div>
  		<div class="panel panel-default">
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseFive" class="panel-collapse collapse">
      <div class="panel-body">
        <p>Blah blah about images and sample data.</p>
      </div>
    </div>
  </div>
  <div class="panel panel-default">
